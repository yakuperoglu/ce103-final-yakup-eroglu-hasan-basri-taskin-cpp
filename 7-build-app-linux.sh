...
reportgenerator "-title:Librarysystem Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" "-sourcedirs:src/utility/src;src/utility/header;src/librarysystem/src;src/librarysystem/header;src/librarysystemapp/src;src/librarysystemapp/header;src/tests/utility;src/tests/librarysystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
