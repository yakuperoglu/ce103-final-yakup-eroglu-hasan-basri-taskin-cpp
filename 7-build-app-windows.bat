...
call reportgenerator "-title:Librarysystem Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Librarysystem Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Librarysystem
call OpenCppCoverage.exe --export_type=binary:librarysystem_tests_unit_win.cov --sources src\librarysystem\src --sources src\librarysystem\header --sources src\tests\librarysystem -- build_win\build\Debug\librarysystem_tests.exe

echo Generate Test Coverage Data for Librarysystem App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=librarysystem_tests_unit_win.cov --export_type=cobertura:librarysystemapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\librarysystem\src --sources src\librarysystem\header --sources src\librarysystemapp\src --sources src\librarysystemapp\header --sources src\tests\utility --sources src\tests\librarysystem -- build_win\build\Debug\librarysystemapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Librarysystem Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/librarysystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/librarysystem/src;src/librarysystem/header;src/librarysystemapp/src;src/librarysystemapp/header;src/tests/utility;src/tests/librarysystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/librarysystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/librarysystem/src;src/librarysystem/header;src/librarysystemapp/src;src/librarysystemapp/header;src/tests/utility;src/tests/librarysystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\librarysystem\header "build_win\build\Release" /E
call robocopy src\librarysystemapp\header "build_win\build\Release" /E
...
call robocopy src\librarysystem\header "build_win\build\Debug" /E
call robocopy src\librarysystemapp\header "build_win\build\Debug" /E
